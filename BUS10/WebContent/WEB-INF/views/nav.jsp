<div >
	<nav class="navbar navbar-expand-lg navbar-lignt bg-success text-white">
		...
		<ul class="nav nav-pills flex-row mb-auto">
			...
			<li class="nav-item">
				<p class="nav-link"  id="appointmentsLink">Appointments</p>

				<div class="dropdown-menu"  aria-labelledby="appointmentsLink">
					<a class="dropdown-item co" href="./getbookapp">Booked
						Appointments</a> <a class="dropdown-item co" href="./appointment">New Appointments</a>
				</div>
			</li>
